...
model_lgb = lgb.LGBMRegressor(n_estimators = 2000, learning_rate = 0.1, random_state = 2,
                              boosting_type = 'gbdt', num_leaves = 300,
                              reg_alpha = 0, subsample= 0.7)
...
model_slgb = lgb.LGBMRegressor(num_leaves=90, n_estimators = 150, learning_rate = 0.1, random_state = 2)#,
                                #boosting_type = 'rf')
